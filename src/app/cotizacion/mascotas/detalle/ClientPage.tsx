...
export default function DetallePolizaMascotaClient() {
  ...
  if (!poliza) {
    return (
      <div className="flex justify-center items-center min-h-[60vh]">
        <p className="text-xl text-gray-700">Cargando detalle de la póliza de mascota...</p>
      </div>
    );
  }
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/3 lg:pr-8 mb-8 lg:mb-0">
              <div className="flex items-center mb-6">
                ...
                <h1 className="text-3xl font-bold text-brand-blue">Seguro de Mascotas {poliza.plan} de {poliza.aseguradora}</h1>
              </div>

              <p className="text-lg text-brand-gray mb-6">
                Dale a tu mascota la protección que se merece con este plan diseñado para su bienestar.
              </p>
              ...
              <ul className="space-y-3 text-brand-gray mb-6">
                 <li className="flex items-center">
                  ...
                  <span><strong>Atención de Emergencias:</strong> Hasta ${poliza.coberturaEmergencias.toLocaleString('es-CO')}</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-6 h-6 text-brand-orange mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                  <span><strong>Consultas Veterinarias:</strong> Hasta ${poliza.coberturaConsultas.toLocaleString('es-CO')}</span>
                </li>
              </ul>
            ...
            <div className="lg:w-1/3 bg-gray-100 p-6 rounded-lg shadow-inner">
              {isCompleted ? (
                <div className="text-center">
                    ...
                    <p className="text-brand-gray">Gracias, {nombre}. Hemos recibido tu solicitud para el seguro de tu mascota.</p>
                ...
                <form onSubmit={handleAcquire}>
                  ...
                  <div className="space-y-4 mb-6">
                    <div>
                        <label htmlFor="nombre" className="block text-sm font-medium text-brand-gray">Tu Nombre Completo</label>
                    ...
                    <div>
                        <label htmlFor="telefono" className="block text-sm font-medium text-brand-gray">Tu Teléfono</label>
                  ...
                  <div className="border-t border-gray-300 pt-3 mt-3 flex justify-between text-xl font-bold text-brand-blue">
                    ...
                    <span>${poliza.valorMensual.toLocaleString('es-CO')}</span>
                  </div>
                  ...
                  <button 
                    ...
                    {isSubmitting ? 'Procesando...' : 'Adquirir Seguro para Mascota'}
                  </button>
