...
export default function CotizarCirugiaPage() {
          ...
          <div className="bg-white rounded-xl shadow-lg p-12 max-w-2xl mx-auto">
            ...
            <div className="animate-pulse">
              <div className="w-32 h-32 mx-auto bg-neutral-200 rounded-full mb-4 flex items-center justify-center">
                <svg className="w-16 h-16 text-brand-gray" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
              </div>
