...
export default function DetallePolizaVidaClient() {
  const searchParams = useSearchParams();
  const [poliza, setPoliza] = useState<PolizaVida | null>(null);
  ...
  if (!poliza) {
    return (
      <div className="flex justify-center items-center min-h-[60vh]">
        <p className="text-xl text-gray-700">Cargando detalle de la póliza de vida...</p>
      </div>
    );
  }
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/3 lg:pr-8 mb-8 lg:mb-0">
              <div className="flex items-center mb-6">
                ...
                <h1 className="text-3xl font-bold text-brand-blue">Seguro de Vida {poliza.plan} de {poliza.aseguradora}</h1>
              </div>

              <p className="text-lg text-brand-gray mb-6">
                Asegura la tranquilidad de tu familia con este completo plan de vida que ofrece respaldo económico en los momentos más difíciles.
              </p>
              ...
              <ul className="space-y-3 text-brand-gray mb-6">
                 <li className="flex items-center">
                  ...
                  <span><strong>Cobertura por Fallecimiento:</strong> ${poliza.coberturaFallecimiento.toLocaleString('es-CO')}</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-6 h-6 text-brand-orange mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                  <span><strong>Cobertura por Invalidez Total y Permanente:</strong> ${poliza.coberturaInvalidez.toLocaleString('es-CO')}</span>
                </li>
              </ul>
            ...
            <div className="lg:w-1/3 bg-gray-100 p-6 rounded-lg shadow-inner">
              {isCompleted ? (
                <div className="text-center">
                    ...
                    <p className="text-brand-gray">Gracias, {nombre}. Hemos recibido tu solicitud para el seguro de vida.</p>
                ...
                <form onSubmit={handleAcquire}>
                  ...
                  <button 
                    ...
                    {isSubmitting ? 'Procesando...' : 'Adquirir Seguro de Vida'}
                  </button>
